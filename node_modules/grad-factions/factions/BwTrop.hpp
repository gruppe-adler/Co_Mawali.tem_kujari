...
class BWTrop: BWFleck {
	class AllUnits: AllUnits {
		uniform[] = {"SMM_Uniform_BW_TT_RS", "SMM_Uniform_BW_TT"};
    ...
    class Type: Type {
        ...
        class medic_F: medic_F {
            backpack = "grad_extras_kit_messenger_coyote_medic";
        };
        ...
        class RangeMaster_F: Soldier_SL_F {
            headgear = "grad_extras_beret_blue";
        };
    };
